"""Tests for database.questions_repo — two-step questions lookup."""
...
from app.agent_service.src.database.questions_repo import fetch_policy_doc_by_category, fetch_questions_by_policy_doc_id
...
async def test_fetch_policy_doc_returns_id_url_and_filename() -> None:
    ...
    with patch("app.agent_service.src.database.questions_repo.asyncpg.connect", AsyncMock(return_value=mock_conn)):
...
async def test_fetch_policy_doc_raises_unknown_category_when_no_row() -> None:
    ...
    with (
        patch("app.agent_service.src.database.questions_repo.asyncpg.connect", AsyncMock(return_value=mock_conn)),
