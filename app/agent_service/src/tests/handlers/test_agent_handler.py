"""Tests for the specialist agent registries in handlers.agent."""

from __future__ import annotations

from app.agent_service.src.handlers.agent import (
    AGENT_REGISTRY,
    CONFIG_REGISTRY,
)
...
def test_agent_module_imports_no_redis_or_eventbridge() -> None:
    ...
    import app.agent_service.src.handlers.agent as agent_module
