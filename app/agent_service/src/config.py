...
``config.yaml``.  Secrets and deployment-specific values
...
def _load_yaml() -> dict[str, Any]:
    """Load ``config.yaml`` from the agent_service root once per cold start."""
...
class LocalRunnerConfig(BaseSettings):
    """Defaults for the local end-to-end runner."""
