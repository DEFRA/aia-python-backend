...
class TestUploadAuth:
    ...
    @patch("utils.dependencies.AuthService.authorise_user", return_value="some-token")
    @patch("utils.dependencies.AuthService.get_user_id", return_value="different-user")
